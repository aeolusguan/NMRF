...
-`[2024/07/18]`: :rocket: [NMRF-Stereo-SwinTiny](docs/swint.md) ranks first on KITTI 2012 and KITTI 2015-NOC, with the pretrained [Swin-T](https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_tiny_patch4_window7_224.pth) as backbone.
